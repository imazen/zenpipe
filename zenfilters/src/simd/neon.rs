//! NEON (AArch64) dispatch targets for zenfilters.
//!
//! Thin `#[arcane]` wrappers that delegate to the shared `wide_simd` module.
...
pub(super) fn scale_plane_impl_neon(token: NeonToken, plane: &mut [f32], factor: f32) {
    super::wide_simd::scale_plane_simd_neon(token, plane, factor);
}
...
#[arcane]
pub(super) fn scale_offset_clamp_plane_impl_neon(
    token: NeonToken,
    plane: &mut [f32],
    factor: f32,
    offset: f32,
    ...
    super::wide_simd::scale_offset_clamp_plane_simd_neon(token, plane, factor, offset, lo, hi);
}

#[arcane]
pub(super) fn offset_plane_impl_neon(token: NeonToken, plane: &mut [f32], offset: f32) {
    super::wide_simd::offset_plane_simd_neon(token, plane, offset);
}
...
pub(super) fn power_contrast_plane_impl_neon(
    ...
    super::wide_simd::power_contrast_plane_simd_neon(token, plane, exp, scale);
}
...
pub(super) fn sigmoid_tone_map_plane_impl_neon(
    ...
    super::wide_simd::sigmoid_tone_map_plane_simd_neon(token, plane, contrast, bias_a);
}
...
pub(super) fn unsharp_fuse_impl_neon(
    ...
    super::wide_simd::unsharp_fuse_simd_neon(token, src, blurred, dst, amount);
}
...
pub(super) fn gaussian_blur_plane_impl_neon(
    ...
    super::wide_simd::gaussian_blur_plane_dispatch_simd_neon(
...
pub(super) fn brilliance_apply_impl_neon(
    ...
    super::wide_simd::brilliance_apply_simd_neon(
        token,
        src_l,
        avg_l,
        dst_l,
...
pub(super) fn scatter_oklab_impl_neon(
    ...
    super::wide_simd::scatter_oklab_simd_neon(token, src, l, a, b, channels, m1, inv_white);
}
...
pub(super) fn gather_oklab_to_srgb_u8_impl_neon(
    ...
    super::wide_simd::gather_oklab_to_srgb_u8_simd_neon(token, l, a, b, dst, channels, m1_inv);
}
...
pub(super) fn black_point_plane_impl_neon(
    ...
    super::wide_simd::black_point_plane_simd_neon(token, plane, bp, inv_range);
}
...
pub(super) fn hue_rotate_impl_neon(
    ...
    super::wide_simd::hue_rotate_simd_neon(token, a, b, cos_r, sin_r);
}
...
pub(super) fn highlights_shadows_impl_neon(
    ...
    super::wide_simd::highlights_shadows_simd_neon(token, plane, shadows, highlights);
}
...
pub(super) fn vibrance_impl_neon(
    ...
    super::wide_simd::vibrance_simd_neon(token, a, b, amount, protection);
}

#[arcane]
pub(super) fn subtract_planes_impl_neon(token: NeonToken, a: &[f32], b: &[f32], dst: &mut [f32]) {
    super::wide_simd::subtract_planes_simd_neon(token, a, b, dst);
}

#[arcane]
pub(super) fn square_plane_impl_neon(token: NeonToken, src: &[f32], dst: &mut [f32]) {
    super::wide_simd::square_plane_simd_neon(token, src, dst);
}
...
pub(super) fn wavelet_threshold_accumulate_impl_neon(
    ...
    super::wide_simd::wavelet_threshold_accumulate_simd_neon(
...
pub(super) fn add_clamped_impl_neon(token: NeonToken, a: &[f32], b: &[f32], dst: &mut [f32]) {
    super::wide_simd::add_clamped_simd_neon(token, a, b, dst);
}
...
pub(super) fn fused_adjust_impl_neon(
    ...
    super::wide_simd::fused_adjust_simd_neon(
        token,
        l,
        a,
        b,
...
pub(super) fn fused_interleaved_adjust_impl_neon(
    ...
    super::wide_simd::fused_interleaved_adjust_simd_neon(
        token,
        src,
        dst,
        channels,
