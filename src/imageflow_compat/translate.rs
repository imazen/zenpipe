...
pub fn zen_registry() -> &'static NodeRegistry {
...
fn push_constrain_node(
    ...
    let def: &dyn NodeDef = &crate::zennode_defs::CONSTRAIN_NODE;
    let mut node = def
        .create_default()
...
// zennode definitions in crate::zennode_defs and zenresize::zennode_defs.
